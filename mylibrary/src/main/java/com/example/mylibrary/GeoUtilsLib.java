...
public class GeoUtilsLib {
     ...
     */
    public static boolean canInsertRegion(Location currentLocation, double newRegionLatitude, double newRegionLongitude, List<Location> regions) {//MapsActivity mA, , Queue<Regioes> regions
