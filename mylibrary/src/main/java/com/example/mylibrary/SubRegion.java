...
public class SubRegion extends Region{
    ...
    public SubRegion(String name, double latitude, double longitude,int user, long timestamp){
        super(name, latitude, longitude, user, timestamp);//(double latitude, double longitude, String nome, int user, long timestamp){
    }
